...
int main() {
    ...
    Lexeme* param_4 = add_param(stack, "param_1", INT, 9, func_1);
    Lexeme* param_5 = add_param(stack, "param_2", INT, 10, func_1);
    Lexeme* param_6 = add_param(stack, "param_3", INT, 11, func_1);
